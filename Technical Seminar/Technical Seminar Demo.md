...
Run `python "Technical Seminar/demo.py"` to show the live seminar demo from the terminal.
cd /workspaces/RIT-MCA-4sem-2026
./.venv/bin/python "Technical Seminar/demo.py"
